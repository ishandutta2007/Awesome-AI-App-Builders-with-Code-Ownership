...
**Other notable mentions**: Cursor, Windsurf, Claude Code, and various AI coding assistants with code export.
...
Let's make AI app creation more open, controllable, and truly owned by the creator.